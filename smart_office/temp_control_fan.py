...
with subprocess.Popen("mosquitto_sub -h 10.32.21.232 -t auto_switch -u changlin03 -P qwe456uio",shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE) as p:
